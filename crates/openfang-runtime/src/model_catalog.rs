...
fn builtin_providers() -> Vec<ProviderInfo> {
    vec![
        ...
        ProviderInfo {
            ...
            display_name: "DashScope Coding Plan (Intl)".into(),
...
fn builtin_models() -> Vec<ModelCatalogEntry> {
    vec![
        ...
        // ══════════════════════════════════════════════════════════════
        // DashScope Coding Plan — International (8)
        // All accessed via ALIBABA_CODING_API_KEY on alibaba_coding provider.
...
mod tests {
    ...
    fn test_catalog_has_providers() {
        let catalog = ModelCatalog::new();
        assert_eq!(catalog.list_providers().len(), 42); // 41 + alibaba_coding
    }
