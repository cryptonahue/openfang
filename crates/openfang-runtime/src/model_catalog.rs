...
use openfang_types::model_catalog::{
    ...
    QIANFAN_BASE_URL, QWEN_BASE_URL, ALIBABA_CODING_BASE_URL,
...
fn builtin_models() -> Vec<ModelCatalogEntry> {
    vec![
        ...
        // ═════════════════════════════════════════════════════════════
        // Alibaba Coding Plan (Intl) — https://coding-intl.dashscope.aliyuncs.com
        // ═════════════════════════════════════════════════════════════
        ModelCatalogEntry {
            id: "qwen3.5-plus".into(),
            display_name: "Qwen3.5 Plus (Coding Plan)".into(),
        ...
        ModelCatalogEntry {
            ...
            display_name: "Qwen3 Max (Coding Plan)".into(),
            provider: "alibaba_coding".into(),
            tier: ModelTier::Frontier,
            context_window: 131_072,
            max_output_tokens: 8_192,
        ...
        ModelCatalogEntry {
            ...
            display_name: "Qwen3 Coder Next (Coding Plan)".into(),
            provider: "alibaba_coding".into(),
            tier: ModelTier::Fast,
            context_window: 131_072,
            max_output_tokens: 8_192,
        ...
        ModelCatalogEntry {
            ...
            display_name: "Qwen3 Coder Plus (Coding Plan)".into(),
            provider: "alibaba_coding".into(),
            tier: ModelTier::Smart,
            context_window: 131_072,
            max_output_tokens: 8_192,
        ...
        // GLM (Zhipu) models on Coding Plan
        ModelCatalogEntry {
            id: "glm-5".into(),
